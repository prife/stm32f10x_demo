...
struct stm32_serial_dma_tx uart5_dma_tx;
...
#ifdef RT_USING_UART5
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOC, ENABLE); /*TX5:PC12*/
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOD, ENABLE); /*RX5:PD2*/
